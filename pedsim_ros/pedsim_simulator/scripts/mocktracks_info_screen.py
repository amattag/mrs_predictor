...
def main():
    # Main code
    #trackPublisher = rospy.Publisher('/spencer/perception/tracked_persons', TrackedPersons, queue_size=5)
    trackPublisher = rospy.Publisher('/pedsim/tracked_persons', TrackedPersons, queue_size=5)
